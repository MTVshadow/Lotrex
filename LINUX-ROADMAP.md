...
|     4 | Core navigation and settings      | Partial | All currently bundled keys in `common`, `collection`, download, extension, game-mode, mod, Nexus, and profile namespaces are structurally covered. Core navigation (Sidebar, Toolbar, Spine, Header, PageGroup) and Extension Manager UI migrated to semantic keys.                                                                                                                                                              |
