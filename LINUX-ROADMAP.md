...
|     9 | Automation and regression gates   |   ✅    | The enhanced `i18n:coverage` command reports every bundled namespace and validates 448/448 keys (100.0% coverage) with zero token/syntax errors, enforces strict mode, and catches obsolete keys and untranslated copies. CI and legacy-key migration gates remain active.                                                                                                                                                       |
